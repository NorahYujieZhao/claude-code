...
const APP_NAME = 'yyyjie URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'yyyjie URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>yyyjie Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for yyyjie
