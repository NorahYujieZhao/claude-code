...
const DEFAULT_PREFIX = `You are yyyjie, an AI coding assistant powered by Anthropic Claude models.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are yyyjie, an AI coding assistant powered by Anthropic Claude models, running within the Claude Agent SDK.`
